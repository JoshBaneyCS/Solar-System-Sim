//go:build rocm_render

package ffi

/*
#cgo LDFLAGS: -L${SRCDIR}/../../native_gpu/rocm -lnative_render_rocm -Wl,-rpath,${SRCDIR}/../../native_gpu/rocm
...
// GPUHardwareInfo contains GPU hardware details detected by the ROCm backend.
